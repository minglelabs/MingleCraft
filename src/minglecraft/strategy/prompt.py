...
JEV_ENGLISH_POLICY = (
    ...
    "Ground commands with null position or tile use independent coordinate-digit questions in the same request. "
    "Answer every requested Choice with an existing option ID; only answers on the selected branch execute."
)
