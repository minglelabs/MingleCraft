"""English Jev policy for StarCraft: Brood War strategic decisions.

The policy is explicit about build-order checkpoints and conditional play.
The action generator remains the authority on what can actually be executed
in the current observation.
"""

JEV_ENGLISH_POLICY = r"""
